(function() {
    ...
    const rawWords = [
      "Giraffe", "Zebra", "Gorilla", "Seal", "Panda", 
      "Kangaroo", "Hippopotamus", "Rhinoceros", "Wolf", "Crocodile", 
      "Alligator", "Lizard", "Chimpanzee", "Whale", "Dolphin", 
      "Shark", "Octopus", "Penguin", "Turtle", "Crab", 
      "Lobster", "Shrimp", "Starfish", "Jellyfish", "Seahorse", 
      "Squid", "Stingray", "Ostrich", "Falcon", "Cobra", 
      "Flamingo", "Scorpion", "Grasshopper", "Cockroach", "Ladybug", 
      "Dragon", "Dinosaur", "Hyena", "Sloth", "Hedgehog", 
      "Eel", "Needlefish", "Oyster", "Woodpecker", "Hummingbird", 
      "Seagull", "Cricket", "Bumblebee", "Caterpillar", "Chameleon", 
      "Centipede", "Leopard"
    ];
    ...
    function showStartScreen() {
        container.innerHTML = `
            <div id="startExam" style="cursor:pointer; text-align:center; animation: fadeIn 0.8s ease;">
                <div style="font-size:3vw; color:#c5a059; letter-spacing:10px; font-weight:900; margin-bottom:10px;">WILD LIFE V10</div>
                ...
                <div style="margin-top:20px; color:rgba(255,255,255,0.3); font-size:1.2vw; letter-spacing:3px;">52 ANIMALS • 3 SECONDS</div>
            </div>
            <style>
    ...
    function renderWord() {
        ...
        // تحجيم الخط الذكي للحيوانات البرية والمائية
        if (word.length <= 6) { fontSize = '20vw'; } 
        else if (word.length <= 9) { fontSize = '15vw'; } 
        else if (word.length <= 12) { fontSize = '11vw'; } 
        else { fontSize = '8vw'; } // للكلمات الطويلة جداً مثل Hippopotamus
        ...
        container.innerHTML = `
            ...
            <div style="text-align:center; width:95%;">
                ...
                <div id="vocabWord" style="
                    ...
                    letter-spacing:-1px; 
                    animation: wildPop 0.3s cubic-bezier(0.17, 0.88, 0.32, 1.28);
                    white-space: nowrap;
            ...
            <style>
                @keyframes wildPop { 0% { opacity:0; transform: scale(1.2); filter: blur(10px); } 100% { opacity:1; transform: scale(1); filter: blur(0); } }
    ...
    function completeExam() {
        ...
        container.innerHTML = `
            <div style="text-align:center; animation: fadeIn 1s ease;">
                ...
                <div style="font-size:5vw; color:#c5a059; font-weight:900; letter-spacing:5px;">WILD LIFE MASTER</div>
                <div style="font-size:2vw; color:#fff; opacity:0.6; margin-top:10px;">Speed Test Successfully Completed</div>
            </div>
        `;
