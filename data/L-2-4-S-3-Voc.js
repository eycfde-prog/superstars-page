(function() {
    ...
    const rawWords = [
        ...
        "Cherry", "Blueberry", "tangerine", "Lemon", "Prickly Pear", "Coconut", "Kiwi", "Sugar Cane", "Pomegranate", "Apricot",
        "Plum", "Fig", "Date", "Raisins", "Cantaloupe", "Avocado", "Guava", "Golden Berry", "Dragon fruit", "Carob",
        "Blackberry", "Honey", "Jam", "Juice", "Yogurt", "Chocolate", "Oats", "Cinnamon", "Olive", "Peanut",
        "Almond", "Walnut", "Cashew", "Hazelnut", "Pistachio", "Mint", "Milk", "Biscuits", "cumin", "salt"
    ];
    ...
    function showStartScreen() {
        container.innerHTML = `
            <div id="startExam" style="cursor:pointer; text-align:center; animation: fadeIn 0.8s ease;">
                <div style="font-size:3vw; color:#c5a059; letter-spacing:10px; font-weight:900; margin-bottom:10px;">FOOD & FRUITS V7</div>
                ...
                <div style="margin-top:20px; color:rgba(255,255,255,0.3); font-size:1.2vw; letter-spacing:3px;">AUTO-NEXT ENABLED • 3s</div>
            </div>
            <style>
    ...
    function renderWord() {
        ...
        // تحجيم الخط الذكي للأطعمة (Food Optimized)
        if (word.length <= 6) { fontSize = '20vw'; } 
        else if (word.length <= 10) { fontSize = '15vw'; } 
        else if (word.length <= 14) { fontSize = '11.5vw'; } 
        else { fontSize = '9vw'; } // للأسماء الطويلة مثل Prickly Pear
        ...
        container.innerHTML = `
            ...
            <div style="text-align:center; width:95%;">
                ...
                <div id="vocabWord" style="
                    ...
                    letter-spacing:-1px; 
                    animation: vetoPop 0.3s cubic-bezier(0.17, 0.88, 0.32, 1.28);
                    white-space: nowrap;
            ...
            <style>
                @keyframes vetoPop { 0% { opacity:0; transform: scale(0.5); } 100% { opacity:1; transform: scale(1); } }
    ...
    function completeExam() {
        ...
        container.innerHTML = `
            <div style="text-align:center; animation: fadeIn 1s ease;">
                ...
                <div style="font-size:5vw; color:#c5a059; font-weight:900; letter-spacing:5px;">SESSION FINISHED</div>
                <div style="font-size:2vw; color:#fff; opacity:0.6; margin-top:10px;">Vocabulary Level 7: Mastered</div>
            </div>
        `;
