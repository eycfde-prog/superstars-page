(function() {
    ...
    function showStartScreen() {
        container.innerHTML = `
            <div id="startExam" style="cursor:pointer; text-align:center; animation: fadeIn 0.8s ease;">
                <div style="font-size:3vw; color:#c5a059; letter-spacing:10px; font-weight:900; margin-bottom:10px;">HOUSE & HOME V6</div>
                ...
                <div style="margin-top:20px; color:rgba(255,255,255,0.3); font-size:1.2vw; letter-spacing:3px;">50 ITEMS • 3 SEC PER ITEM</div>
            </div>
            <style>
    ...
    function renderWord() {
        ...
        // تحجيم الخط الذكي للمصطلحات المنزلية (House Optimized)
        if (word.length <= 6) { fontSize = '20vw'; } 
        else if (word.length <= 12) { fontSize = '14vw'; } 
        else if (word.length <= 16) { fontSize = '11vw'; } 
        else { fontSize = '9vw'; } // للجمل الطويلة مثل Washing machine
        ...
        container.innerHTML = `
            ...
            <style>
                @keyframes vetoSlideIn { 0% { opacity:0; transform: translateX(50px); } 100% { opacity:1; transform: translateX(0); } }
    ...
    function completeExam() {
        ...
        container.innerHTML = `
            <div style="text-align:center; animation: fadeIn 1s ease;">
                ...
                <div style="font-size:5vw; color:#c5a059; font-weight:900; letter-spacing:5px;">HOUSE MASTERED</div>
                <div style="font-size:2vw; color:#fff; opacity:0.6; margin-top:10px;">All furniture items completed</div>
            </div>
        `;
