/**
 * VETO PROGRAM - Listening Activity Module (Session 15)
 * Designed by: Veto Architect
 * Content: Level 1 - Session 15 (Conversations 9-12)
 */
...
(function() {
    ...
    // --- Data Storage (Session 15 Content) ---
    const conversations = [
        `[Ahmed - Curious]: What did you buy from the supermarket, Amy? <break time="1.5s" /> [Amy - Answering]: I bought some fruits and a bottle of juice. <break time="1.5s" /> [Ahmed - Asking]: Were you paying with cash or a card? <break time="1.5s" /> [Amy - Normal]: I was paying with my card when I saw Julia there.`,
        `[Chris - Excited]: Julia, I found a new English story in the library. <break time="1.5s" /> [Julia - Interested]: Was it the White Valley story? <break time="1.5s" /> [Chris - Confirming]: Yes, it was. <break time="1.0s" /> I read the first ten pages yesterday. <break time="1.5s" /> [Julia - Asking]: Did you find any difficult words in it? <break time="1.5s" /> [Chris - Normal]: No, I knew most of them from Level Two.`,
        `[Amy - Worried]: Ahmed, I lost my pen in the classroom. <break time="1.5s" /> [Ahmed - Asking]: Did you look for it under the desk? <break time="1.5s" /> [Amy - Replying]: Yes, I was looking everywhere but I did not find it. <break time="1.5s" /> [Ahmed - Offering]: Take this pen. <break time="1.0s" /> I have two pens in my pencil case.`,
        `[Julia - Curious]: Why were you laughing during the break, Chris? <break time="1.5s" /> [Chris - Smiling]: Because Ahmed told a very funny joke. <break time="1.5s" /> [Julia - Asking]: Did the teacher hear the joke too? <break time="1.5s" /> [Chris - Normal]: No, he was talking to another student at that time.`
    ];

    let currentIdx = 0;
    const audioPlayer = new Audio();
    
    // تحديث المسار إلى Session 15
    const audioBaseUrl = "https://raw.githubusercontent.com/eycfde-prog/EYCVetoProgram/main/data/Listening/Level-1/Session%2015/";
