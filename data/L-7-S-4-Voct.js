(function() {
    ...
    const rawWords = [
        ...
        "Coat", "Sweater", "Hoodie", "Vest", "Pajamas", "lipstick", "Socks", "Shoes", "Sneakers", "Boots",
        "Flip-flops", "Slippers", "Heels", "Hat", "Cap", "Scarf", "Gloves", "Belt", "Tie", "Bow tie",
        "Glasses", "Sunglasses", "Watch", "Ring", "Necklace", "Bracelet", "Earrings", "Handbag", "Backpack", "Wallet",
        "Umbrella", "Button", "Zipper", "Pocket", "Uniform", "lighter", "Swimsuit", "Bathrobe", "Jewelry", "Suitcase"
    ];
    ...
    function showStartScreen() {
        container.innerHTML = `
            <div id="startExam" style="cursor:pointer; text-align:center; animation: fadeIn 0.8s ease;">
                <div style="font-size:3vw; color:#c5a059; letter-spacing:10px; font-weight:900; margin-bottom:10px;">CLOTHING V14</div>
                <div style="font-size:6vw; color:#fff; font-weight:900; text-transform:uppercase; line-height:1;">SPEED TEST</div>
                <div style="margin-top:40px; background:#c5a059; color:#000; padding:20px 60px; font-size:2vw; font-weight:900; border-radius:50px; display:inline-block; transition:0.3s;">START SESSION</div>
                <div style="margin-top:20px; color:rgba(255,255,255,0.3); font-size:1.2vw; letter-spacing:3px;">50 FASHION ITEMS • 3s AUTO-PLAY</div>
            </div>
            <style>
    ...
    function renderWord() {
        ...
        // تحجيم الخط الذكي للملابس (Fashion Optimized)
        if (word.length <= 5) { fontSize = '22vw'; } 
        else if (word.length <= 8) { fontSize = '17vw'; } 
        else if (word.length <= 11) { fontSize = '13vw'; } 
        else { fontSize = '9.5vw'; } // للمصطلحات الطويلة مثل Sunglasses
        ...
        container.innerHTML = `
            ...
            <div style="text-align:center; width:95%;">
                ...
                <div id="vocabWord" style="
                    ...
                    letter-spacing:-1px; 
                    animation: fashionIn 0.3s ease-out;
                    white-space: nowrap;
            ...
            <style>
                @keyframes fashionIn { 0% { opacity:0; transform: translateY(-20px); filter: blur(5px); } 100% { opacity:1; transform: translateY(0); filter: blur(0); } }
    ...
    function completeExam() {
        ...
        container.innerHTML = `
            <div style="text-align:center; animation: fadeIn 1s ease;">
                ...
                <div style="font-size:5vw; color:#c5a059; font-weight:900; letter-spacing:5px;">FASHION MASTER!</div>
                <div style="font-size:2vw; color:#fff; opacity:0.6; margin-top:10px;">Clothing & Accessories Completed</div>
            </div>
        `;
