(function() {
    ...
    const ttNumber = 31; 
    const ttSentence = "Thirty-three thousand feathers on a thrush’s throat.";
    
    // WOLF Fix: سحب الصورة رقم 31 من مسار GitHub المعتمد
    ...
    // WOLF Logic: تلوين صوت الـ TH المهيمن في هذه الجملة الصعبة
    ...
    container.innerHTML = `
        <style>
            .tt-wrapper { 
                ...
                flex-direction: column;
                align-items: center;
                animation: featherFloat 1s cubic-bezier(0.22, 1, 0.36, 1); 
            }
            ...
            /* اللون المتوهج لصوت الـ TH */
            .th-sound { color: #d4af37; text-shadow: 0 0 25px rgba(212, 175, 55, 0.9); }
        ...
        <div class="tt-wrapper">
            ...
            <div class="tt-main-card">
                ...
                <div class="tt-image-container">
                    <img src="${imageUrl}" onerror="this.src='https://via.placeholder.com/400/160033/ffffff?text=FEATHERS'" style="width:100%; height:100%; object-fit:cover;">
                </div>
            </div>
        </div>
    `;
