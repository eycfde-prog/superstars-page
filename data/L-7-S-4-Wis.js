(function() {
    ...
    container.innerHTML = '';
    // تعديل: إضافة padding-top و padding-bottom وتغيير overflow لـ auto
    container.style.cssText = `height:100%; display:flex; flex-direction:column; align-items:center; justify-content:flex-start; background:#05010a; color:#fff; font-family: 'Inter', sans-serif; position:relative; overflow-y:auto; padding: 40px 0;`;
    ...
    container.innerHTML = `
        <style>
            ...
            .genie-avatar { 
                width: 150px; /* صغرنا الحجم قليلاً للتناسب */
                margin-bottom: 10px; /* لغينا المارجن السالب اللي كان بيسحب الكارت لفوق */
            ...
            .wish-card {
                ...
                padding: 50px 30px; border-radius: 40px; 
                border: 4px solid #f59e0b;
                text-align: center; position: relative; z-index: 5;
                animation: magicGlow 5s infinite;
                /* تم تبسيط الـ clip-path لضمان عدم قص الحواف بشكل حاد */
                box-sizing: border-box;
                margin-bottom: 20px;
            }

            .badge { 
                background: #f59e0b; color: #000; padding: 5px 25px; 
            ...
            .scenario-text { 
                font-size: 1.5rem; line-height: 1.3; color: #fef3c7; 
                margin: 25px 0 30px 0; font-style: italic; font-weight: 600;
            }
            ...
            .point-item { 
                ...
                font-size: 1.1rem; color: #e9d5ff;
                display: flex; align-items: center;
                border-left: 4px solid #f59e0b;
                transition: 0.3s;
            }
            .point-item:hover { background: rgba(255,255,255,0.1); transform: scale(1.01); }

            .magic-dust { 
                position: absolute; width: 100%; height: 100%;
                background-image: radial-gradient(#9b59b6 1px, transparent 1px);
                background-size: 50px 50px; opacity: 0.1; top: 0; left:0;
                pointer-events: none;
            }
        </style>
