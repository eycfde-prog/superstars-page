    ...
    function showStartScreen() {
        container.innerHTML = `
            <div id="startExam" style="cursor:pointer; text-align:center; animation: fadeIn 0.8s ease;">
                <div style="font-size:3vw; color:#c5a059; letter-spacing:10px; font-weight:900; margin-bottom:10px;">PLACES V12</div>
                <div style="font-size:6vw; color:#fff; font-weight:900; text-transform:uppercase; line-height:1;">SPEED TEST</div>
                <div style="margin-top:40px; background:#c5a059; color:#000; padding:20px 60px; font-size:2vw; font-weight:900; border-radius:50px; display:inline-block; transition:0.3s;">EXPLORE WORLD</div>
                <div style="margin-top:20px; color:rgba(255,255,255,0.3); font-size:1.2vw; letter-spacing:3px;">AUTO-ADVANCE • 3s INTERVAL</div>
            </div>
            <style>
        ...
        container.innerHTML = `
            ...
            <div style="text-align:center; width:95%;">
                ...
                <div id="vocabWord" style="
                    ...
                    letter-spacing:-1px; 
                    animation: placeZoom 0.4s ease-out;
                    white-space: nowrap;
            ...
            <style>
                @keyframes placeZoom { 0% { opacity:0; transform: scale(0.8); } 100% { opacity:1; transform: scale(1); } }
    ...
    function completeExam() {
        ...
        container.innerHTML = `
            <div style="text-align:center; animation: fadeIn 1s ease;">
                ...
                <div style="font-size:5vw; color:#c5a059; font-weight:900; letter-spacing:5px;">LOCATION MASTER!</div>
                <div style="font-size:2vw; color:#fff; opacity:0.6; margin-top:10px;">World Geography Level 12 Completed</div>
            </div>
        `;
