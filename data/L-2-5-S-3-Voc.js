(function() {
    ...
    const rawWords = [
        "Dove", "Fox", "Puppy", "Kitten", "Rabbit", "Hamster", "Parrot", "Clownfish", "Tortoise", "Bird",
        "Horse", "Cow", "Sheep", "Goat", "Chicken", "Rooster", "Peacock", "Duck", "Goose", "Turkey",
        "Donkey", "Camel", "Bear", "Bull", "Calf", "Lamb", "Cheetah", "Mouse", "Bee", "Butterfly",
        "Ant", "Housefly", "Mosquito", "Spider", "Worm", "Snail", "Frog", "Snake", "Pigeon", "Eagle",
        "Owl", "Crow", "Swan", "Bat", "Squirrel", "Monkey", "Deer", "Lion", "Tiger", "Elephant"
    ];
    ...
    function showStartScreen() {
        container.innerHTML = `
            <div id="startExam" style="cursor:pointer; text-align:center; animation: fadeIn 0.8s ease;">
                <div style="font-size:3vw; color:#c5a059; letter-spacing:10px; font-weight:900; margin-bottom:10px;">ANIMALS V9</div>
                ...
                <div style="margin-top:20px; color:rgba(255,255,255,0.3); font-size:1.2vw; letter-spacing:3px;">3s PER ANIMAL • FULL SHUFFLE</div>
            </div>
            <style>
        ...
        container.innerHTML = `
            ...
            <div style="text-align:center; width:95%;">
                ...
                <div id="vocabWord" style="
                    ...
                    letter-spacing:-1px; 
                    animation: animalIn 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275);
                    white-space: nowrap;
            ...
            <style>
                @keyframes animalIn { 0% { opacity:0; transform: scale(0.5) rotate(-5deg); } 100% { opacity:1; transform: scale(1) rotate(0); } }
    ...
    function completeExam() {
        ...
        container.innerHTML = `
            <div style="text-align:center; animation: fadeIn 1s ease;">
                ...
                <div style="font-size:5vw; color:#c5a059; font-weight:900; letter-spacing:5px;">KING OF THE JUNGLE!</div>
                <div style="font-size:2vw; color:#fff; opacity:0.6; margin-top:10px;">Animal Kingdom Level 9 Completed</div>
            </div>
        `;
