(function() {
    ...
    function showStartScreen() {
        container.innerHTML = `
            <div id="startExam" style="cursor:pointer; text-align:center; animation: fadeIn 0.8s ease;">
                <div style="font-size:3vw; color:#c5a059; letter-spacing:10px; font-weight:900; margin-bottom:10px;">ADJECTIVES V3</div>
                ...
                <div style="margin-top:20px; color:rgba(255,255,255,0.3); font-size:1.2vw; letter-spacing:3px;">3 SECONDS PER WORD • SHUFFLE ON</div>
            </div>
            <style>
    ...
    function renderWord() {
        ...
        // منطق Veto للخط الذكي (Wolf Optimized)
    ...
    function completeExam() {
        ...
        container.innerHTML = `
            <div style="text-align:center; animation: fadeIn 1s ease;">
                ...
                <div style="font-size:5vw; color:#c5a059; font-weight:900; letter-spacing:5px;">CHALLENGE COMPLETE</div>
                <div style="font-size:2vw; color:#fff; opacity:0.6; margin-top:10px;">Adjectives Mastery Confirmed</div>
            </div>
        `;
