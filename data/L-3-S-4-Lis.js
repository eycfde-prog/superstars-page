/**
 * VETO PROGRAM - Listening Activity Module (Session 11)
 * Designed by: Veto Architect
 * Content: Level 1 - Session 11 (Conversations 9-12)
 */
...
(function() {
    ...
    // --- Data Storage (Session 11 Content) ---
    const conversations = [
        `[Ahmed - Warning]: Be quiet, Amy! <break time="1.0s" /> The baby is sleeping in the room. <break time="1.5s" /> [Amy - Whispering]: Oh, sorry. <break time="1.0s" /> What is mother doing now? <break time="1.5s" /> [Ahmed - Whispering]: She is cooking lunch for the family. <break time="1.5s" /> [Amy - Hungry]: I can smell the delicious food from here.`,
        `[Chris - Asking]: Do you use the Veto website every evening? <break time="1.5s" /> [Julia - Confirming]: Yes, I always check my profile and my homework. <break time="1.5s" /> [Chris - Interested]: I am checking my rank on the leaderboard now. <break time="1.5s" /> [Julia - Happy]: Wow! <break time="1.0s" /> You are doing a great job, Chris.`,
        `[Amy - Confused]: I do not understand this Present Continuous rule. <break time="1.5s" /> [Ahmed - Helpful]: Do not worry. <break time="1.0s" /> I am explaining it to you right now. <break time="1.5s" /> [Amy - Relieved]: Thank you, Ahmed. <break time="1.0s" /> You are a very kind brother. <break time="1.5s" /> [Ahmed - Smiling]: We are learning together to be the best.`,
        `[Julia - Asking]: Does Chris drink coffee every morning? <break time="1.5s" /> [Chris - Replying]: No, I prefer drinking tea or orange juice. <break time="1.5s" /> [Julia - Normal]: That is healthy. <break time="1.0s" /> I am drinking water right now. <break time="1.5s" /> [Chris - Agreeing]: Water is the best thing for our bodies.`
    ];

    let currentIdx = 0;
    const audioPlayer = new Audio();
    
    // تحديث المسار إلى Session 11
    const audioBaseUrl = "https://raw.githubusercontent.com/eycfde-prog/EYCVetoProgram/main/data/Listening/Level-1/Session%2011/";
