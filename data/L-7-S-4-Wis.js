(function() {
    ...
    container.innerHTML = '';
    // WOLF: تم إلغاء padding-top واستخدام center لضمان التوسط في الفول سكرين
    container.style.cssText = `height:100%; display:flex; flex-direction:column; align-items:center; justify-content: center; background:#05010a; color:#fff; font-family: 'Inter', sans-serif; position:relative; overflow:hidden; transition: background 0.8s ease;`;
    ...
    container.innerHTML = `
        <style>
            ...
            .wish-wrapper {
                ...
                max-width: 1000px;
                height: auto;
                max-height: 90vh; /* يضمن عدم خروج المحتوى عن الشاشة */
                display: flex;
            ...
            /* Responsive tweaks for smaller screens or landscape mobile */
            @media (max-height: 600px) {
                .scenario-text { font-size: 1.4rem; margin-bottom: 15px; }
                .point-item { padding: 10px; font-size: 1rem; }
    ...
    function updateDisplay(index) {
        ...
        card.style.transform = 'translateY(20px)'; // WOLF: حركة أنعم من الدوران
