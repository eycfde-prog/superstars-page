/**
 * VETO PROGRAM - Listening Activity Module (Session 3)
 * Designed by: Veto Architect
 * Content: Level 1 - Session 3
 */
...
(function() {
    ...
    // --- Data Storage (Session 3 Content) ---
    const conversations = [
        `[Ahmed - Hungry]: I have a sandwich and an egg for breakfast. <break time="1.5s" /> [Amy - Offering]: Do you want my milk? <break time="1.5s" /> [Ahmed - Polite]: No, thank you. <break time="1.0s" /> I have a bottle of water. <break time="1.5s" /> [Amy - Normal]: It is important to eat well.`,
        `[Chris - Describing]: Look at my new shirt. <break time="1.0s" /> Is it nice? <break time="1.5s" /> [Julia - Approving]: Yes, it is a great shirt. <break time="1.0s" /> It is very clean. <break time="1.5s" /> [Chris - Proud]: My mother buys it for me. <break time="1.5s" /> [Julia - Smiling]: She is very kind.`,
        `[Amy - Excited]: Ahmed, look at my profile on the Veto website! <break time="1.5s" /> [Ahmed - Impressed]: Wow! <break time="1.0s" /> Your rank is very high. <break time="1.5s" /> [Amy - Proud]: I do my homework every day. <break time="1.5s" /> [Ahmed - Encouraging]: Keep it up, Amy.`,
        `[Julia - Pointing]: Look! <break time="1.0s" /> A small kitten is under the chair. <break time="1.5s" /> [Chris - Calm]: It is very cute. <break time="1.0s" /> It is hungry. <break time="1.5s" /> [Julia - Softly]: I have some milk for it. <break time="1.5s" /> [Chris - Normal]: You are a good girl.`
    ];

    let currentIdx = 0;
    const audioPlayer = new Audio();
    
    // تحديث المسار إلى Session 3
    const audioBaseUrl = "https://raw.githubusercontent.com/eycfde-prog/EYCVetoProgram/main/data/Listening/Level-1/Session%203/";
