(function() {
    ...
    const rawWords = [
        ...
        "Finger", "Thumb", "Fingernail", "Chest", "Stomach", "Backbone", "Waist", "Hip", "Leg", "Knee",
        "Ankle", "Foot", "Heel", "Toe", "Skin", "Bone", "Muscle", "Blood", "Heart", "Lungs",
        "Brain", "Throat", "Veins", "Arteries", "Liver", "Kidney", "Rib", "Ring finger", "Fist", "Body"
    ];
    ...
    function showStartScreen() {
        container.innerHTML = `
            <div id="startExam" style="cursor:pointer; text-align:center; animation: fadeIn 0.8s ease;">
                <div style="font-size:3vw; color:#c5a059; letter-spacing:10px; font-weight:900; margin-bottom:10px;">BODY PARTS V13</div>
                <div style="font-size:6vw; color:#fff; font-weight:900; text-transform:uppercase; line-height:1;">SPEED TEST</div>
                <div style="margin-top:40px; background:#c5a059; color:#000; padding:20px 60px; font-size:2vw; font-weight:900; border-radius:50px; display:inline-block; transition:0.3s;">START TEST</div>
                <div style="margin-top:20px; color:rgba(255,255,255,0.3); font-size:1.2vw; letter-spacing:3px;">50 ANATOMY WORDS • 3s INTERVAL</div>
            </div>
            <style>
        ...
        container.innerHTML = `
            ...
            <div style="text-align:center; width:95%;">
                ...
                <div id="vocabWord" style="
                    ...
                    letter-spacing:-1px; 
                    animation: anatomyPop 0.3s cubic-bezier(0.18, 0.89, 0.32, 1.28);
                    white-space: nowrap;
            ...
            <style>
                @keyframes anatomyPop { 0% { opacity:0; transform: scale(0.8); } 100% { opacity:1; transform: scale(1); } }
    ...
    function completeExam() {
        ...
        container.innerHTML = `
            <div style="text-align:center; animation: fadeIn 1s ease;">
                ...
                <div style="font-size:5vw; color:#c5a059; font-weight:900; letter-spacing:5px;">BODY EXPERT!</div>
                <div style="font-size:2vw; color:#fff; opacity:0.6; margin-top:10px;">Anatomy Speed Test Completed</div>
            </div>
        `;
