/**
 * VETO PROGRAM - Listening Activity Module (Session 9)
 * Designed by: Veto Architect
 * Content: Level 1 - Session 9 (Conversations 1-4)
 */
...
(function() {
    ...
    // --- Data Storage (Session 9 Content) ---
    const conversations = [
        `[Ahmed - Informative]: I usually wake up at six o'clock every morning. <break time="1.5s" /> [Amy - Asking]: Do you brush your teeth before breakfast? <break time="1.5s" /> [Ahmed - Normal]: Yes, I do. <break time="1.0s" /> Then I eat my breakfast and go to Veto. <break time="1.5s" /> [Amy - Simple]: I also follow a healthy routine every day.`,
        `[Chris - Curious]: What is Julia doing in the kitchen right now? <break time="1.5s" /> [Julia - Shouting far]: I am making some tea for us! <break time="1.5s" /> [Chris - Smiling]: That is great. <break time="1.0s" /> I am studying my English grammar lesson. <break time="1.5s" /> [Julia - Friendly]: I am coming to help you in five minutes.`,
        `[Amy - Asking]: Does Ahmed play football on Fridays? <break time="1.5s" /> [Ahmed - Replying]: No, I do not play football on Fridays. <break time="1.5s" /> [Amy - Curious]: What do you do then? <break time="1.5s" /> [Ahmed - Enthusiastic]: I always practice my DMT talk for the next class.`,
        `[Julia - Observing]: Look! <break time="1.0s" /> The students are running in the garden. <break time="1.5s" /> [Chris - Normal]: They are playing a game during the break. <break time="1.5s" /> [Julia - Asking]: Does the teacher watch them every day? <break time="1.5s" /> [Chris - Confirming]: Yes, he watches them to keep them safe.`
    ];

    let currentIdx = 0;
    const audioPlayer = new Audio();
    
    // تحديث المسار إلى Session 9
    const audioBaseUrl = "https://raw.githubusercontent.com/eycfde-prog/EYCVetoProgram/main/data/Listening/Level-1/Session%209/";
