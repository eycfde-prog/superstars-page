...
(function() {
    ...
    const conversations = [
        `[Ahmed - Curious]: What happened to the old building which was next to our school? <break time="1.5s" /> [Amy - Replying]: It was torn down to build a new lab where we can do experiments. <break time="1.5s" /> [Ahmed - Excited]: That is wonderful! <break time="1.0s" /> However, will it be ready by next semester? <break time="1.5s" /> [Amy - Normal]: Yes, despite the rain, the workers are finishing it quickly. <break time="1.5s" /> [Ahmed - Happy]: I can't wait to see the new equipment.`,
        `[Chris - Asking]: Whose turn is it to present the DMT today? <break time="1.5s" /> [Julia - Replying]: It is Ahmed, who has been preparing his talk for a week. <break time="1.5s" /> [Chris - Curious]: Is it the talk that discusses environmental issues? <break time="1.5s" /> [Julia - Confirming]: Yes, and the more he practices, the more confident he sounds. <break time="1.5s" /> [Chris - Encouraging]: He is a student that always puts in a lot of effort.`,
        `[Amy - Reflective]: Although I studied French for years, I find English much easier. <break time="1.5s" /> [Ahmed - Asking]: Why is that? <break time="1.0s" /> Is it because of the methods that Veto uses? <break time="1.5s" /> [Ahmed - Replying]: Yes, the way in which they teach makes everything stick in my mind. <break time="1.5s" /> [Amy - Agreeing]: In spite of the long hours, I never feel bored in class. <break time="1.5s" /> [Ahmed - Smiling]: The more you enjoy the process, the faster you learn.`,
        `[Julia - Organizing]: Please put away your books which are on the floor. <break time="1.5s" /> [Chris - Asking]: Should I also turn off the computer that is in the corner? <break time="1.5s" /> [Julia - Confirming]: Yes, however, make sure you save your work first. <break time="1.5s" /> [Chris - Normal]: I have already done that. <break time="1.0s" /> I will also take out the trash. <break time="1.5s" /> [Julia - Grateful]: Thank you! <break time="1.0s" /> You are very helpful today.`
    ];

    let currentIdx = 0;
    const audioPlayer = new Audio();
    
    // توجيه المسار الصوتي إلى Session 23
