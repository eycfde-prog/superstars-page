...
const words = [ "Sun", "Moon", "Star", "Sky", "Cloud", "Rain", "Snow", "Wind", "Storm", "Thunder", "Lightning", "Fog", "Rainbow", "Ice", "Heat", "Cold", "Summer", "Winter", "Spring", "Autumn", "Mountain", "Hill", "Valley", "Forest", "Jungle", "Desert", "Island", "Beach", "Ocean", "Sea", "River", "Lake", "Waterfall", "Cave", "Volcano", "Earthquake", "Earth", "Planet", "Space", "Tree", "Flower", "Leaf", "Grass", "Plant", "Rock", "Stone", "Sand", "Dust", "Air", "Nature" ];
    ...
    function playSound(index) {
        ...
        const audioPath = `data/vocab/v18/${index + 1}.wav`;
