...
(function() {
    ...
    const rawWords = [
        "Thick", "Thin", "Sharp", "Blunt", "Bright", "Dim",
        "Loud", "Quiet", "Brave", "Afraid", "Clever", "Stupid",
        "Kind", "Cruel", "Polite", "Impolite", "Famous", "Unknown",
        "Busy", "Free", "Public", "Private", "Modern", "Ancient",
        "Natural", "Artificial", "Sweet", "Sour", "True", "False",
        "Normal", "Strange", "Tight", "Loose", "Rough", "Smooth",
        "Deep", "Shallow", "Alive", "Dead", "Same", "Different",
        "Useful", "Useless", "Careful", "Careless", "Visible", "Invisible",
        "Together", "Alone"
    ];
    ...
    function showStartScreen() {
        container.innerHTML = `
            <div id="startExam" style="cursor:pointer; text-align:center; animation: fadeIn 0.8s ease;">
                <div style="font-size:3vw; color:#c5a059; letter-spacing:10px; font-weight:900; margin-bottom:10px;">ADJECTIVES V4</div>
                ...
                <div style="margin-top:20px; color:rgba(255,255,255,0.3); font-size:1.2vw; letter-spacing:3px;">AUTO-NEXT: 3 SECONDS</div>
            </div>
            <style>
    ...
    function renderWord() {
        ...
        // تحجيم الخط الذكي (Wolf Optimized)
        ...
        container.innerHTML = `
            ...
            <style>
                @keyframes vetoPopIn { 0% { opacity:0; transform: scale(0.7); } 100% { opacity:1; transform: scale(1); } }
    ...
    function completeExam() {
        ...
        container.innerHTML = `
            <div style="text-align:center; animation: fadeIn 1s ease;">
                ...
                <div style="font-size:5vw; color:#c5a059; font-weight:900; letter-spacing:5px;">EXAM FINISHED</div>
                <div style="font-size:2vw; color:#fff; opacity:0.6; margin-top:10px;">Vocabulary Level 4: Mastered</div>
            </div>
        `;
