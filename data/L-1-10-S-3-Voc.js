...
const words = [ "Break a leg", "Piece of cake", "Under the weather", "Once in a blue moon", "Call it a day", "Keep in touch", "Look after", "Give up", "Carry on", "Find out", "Get along", "Run out of", "Take care of", "Turn up", "Turn down", "Look forward to", "Put off", "Take off", "Set up", "Make up", "Break up", "Catch up", "Hold on", "Calm down", "Check in", "Check out", "Come across", "Cut down on", "Fall apart", "Get over", "Give in", "Grow up", "Hang out", "Let down", "Look for", "Pass out", "Pick up", "Point out", "Put up with", "Show off", "Stand out", "Work out", "Cheer up", "Calm down", "Go on", "Better late than never", "No pain no gain", "Break the ice", "So far so good", "Easy come easy go" ];
    ...
    function playSound(index) {
        ...
        const audioPath = `data/vocab/v20/${index + 1}.wav`;
