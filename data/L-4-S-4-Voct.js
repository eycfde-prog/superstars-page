(function() {
    ...
    function showStartScreen() {
        container.innerHTML = `
            <div id="startExam" style="cursor:pointer; text-align:center; animation: fadeIn 0.8s ease;">
                <div style="font-size:3vw; color:#c5a059; letter-spacing:10px; font-weight:900; margin-bottom:10px;">VEGETABLES V8</div>
                ...
                <div style="margin-top:20px; color:rgba(255,255,255,0.3); font-size:1.2vw; letter-spacing:3px;">50 WORDS • AUTO-PLAY ON</div>
            </div>
            <style>
    ...
    function renderWord() {
        ...
        // تحجيم الخط الذكي للخضروات (Vegetables Optimized)
        if (word.length <= 6) { fontSize = '20vw'; } 
        else if (word.length <= 10) { fontSize = '15vw'; } 
        else if (word.length <= 14) { fontSize = '11.5vw'; } 
        else { fontSize = '8.5vw'; } // للأسماء الطويلة جداً مثل Black-eyed Peas
        ...
        container.innerHTML = `
            ...
            <div style="text-align:center; width:95%;">
                ...
                <div id="vocabWord" style="
                    ...
                    letter-spacing:-1px; 
                    animation: vetoSlideUp 0.3s cubic-bezier(0.23, 1, 0.32, 1);
                    white-space: nowrap;
            ...
            <style>
                @keyframes vetoSlideUp { 0% { opacity:0; transform: translateY(50px); } 100% { opacity:1; transform: translateY(0); } }
    ...
    function completeExam() {
        ...
        container.innerHTML = `
            <div style="text-align:center; animation: fadeIn 1s ease;">
                ...
                <div style="font-size:5vw; color:#c5a059; font-weight:900; letter-spacing:5px;">VEGGIE EXPERT!</div>
