    ...
    function renderWord() {
        container.innerHTML = `
            <div style="text-align:center;">
                ...
                <div id="vocabWord" style="font-size:10rem; font-weight:900; color:#fff; text-transform:uppercase; letter-spacing:8px; text-shadow: 0 0 20px rgba(52, 152, 219, 0.4);">
                    ${words[currentIndex]}
                </div>
                <div style="margin-top:50px; color:#3498db; font-size:1.8rem; letter-spacing:5px; font-weight:bold;">PETS & FARM ANIMALS</div>
            </div>
        `;
