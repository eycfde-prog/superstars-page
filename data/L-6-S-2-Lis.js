...
(function() {
    ...
    const conversations = [
        `[Ahmed - Thoughtful]: I think I will start my revision for the final test tomorrow. <break time="1.5s" /> [Amy - Asking]: Are you going to study at the library or at home? <break time="1.5s" /> [Ahmed - Normal]: I am meeting Chris at the Veto center at four o'clock. <break time="1.5s" /> [Amy - Advice]: You should bring your grammar notebook with you. <break time="1.5s" /> [Ahmed - Resolute]: I will. <break time="1.0s" /> I must finish this level with a high score.`,
        `[Chris - Worried]: Julia, I might fail the Squeezer activity today. <break time="1.5s" /> [Julia - Encouraging]: No, you won't! <break time="1.0s" /> You can answer all the questions easily. <break time="1.5s" /> [Chris - Asking]: Should I practice the fast-reading technique again? <break time="1.5s" /> [Julia - Confirming]: Yes, you must practice if you want to be the winner. <break time="1.5s" /> [Chris - Determined]: Okay, I am going to spend two hours on it now.`,
        `[Amy - Curious]: Ahmed, what are you going to do after the class? <break time="1.5s" /> [Ahmed - Planning]: I am going to record my DMT talk for next week. <break time="1.5s" /> [Amy - Asking]: Can you help me with my Reading task later? <break time="1.5s" /> [Ahmed - Helpful]: Of course, I could help you at seven o'clock. <break time="1.5s" /> [Amy - Relieved]: Thanks! <break time="1.0s" /> I will wait for your call then.`,
        `[Julia - Observing]: The sky is very dark. <break time="1.0s" /> It is going to rain soon. <break time="1.5s" /> [Chris - Quick decision]: I will take my umbrella before I leave. <break time="1.5s" /> [Julia - Warning]: You must be careful while driving in the rain. <break time="1.5s" /> [Chris - Normal]: I know. <break time="1.0s" /> I might stay at the institute until the rain stops. <break time="1.5s" /> [Julia - Agreeing]: That is a good idea. <break time="1.0s" /> You shouldn't take any risks.`
    ];

    let currentIdx = 0;
    const audioPlayer = new Audio();
    
    // توجيه المسار إلى Session 21
